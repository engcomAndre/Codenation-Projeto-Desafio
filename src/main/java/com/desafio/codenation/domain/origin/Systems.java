...
public class Systems extends Origins implements Serializable {
    ...
    public Systems(Long id, String nome, String descricao, String chave, String password, Boolean ativo, Set<TypeUser> perfis, List<User> users, List<Events> events, LocalDateTime createdAt) {
