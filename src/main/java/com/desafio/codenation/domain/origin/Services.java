...
public class Services extends Origins implements Serializable {
    ...
    public Services(Long id, String nome, String descricao, String chave, String password, Boolean ativo, Set<TypeUser> perfis, List<Events> events, LocalDate createdAt) {
